package com.arquitechthor.inditest.infrastructure.adapter.out.persistence.repository;

import java.time.LocalDateTime;
import java.util.Optional;

import com.arquitechthor.inditest.infrastructure.adapter.out.persistence.entity.PriceEntity;
